...
class EditAddressForm extends Component {
  ...
  render() {
    const { fields, handleSubmit, cancelHandler, submitting } = this.props;
    return (
        ...
        <div className="ui two column grid">
          ...
          <div className="row">
            <div className="sixteen wide column Ta(e)">
              <button className="ui icon button" onClick={ cancelHandler } disabled={ submitting }>
                <i className="fa fa-times"></i>
                <span className="Mstart(10px)">Cancel</span>
              </button>
              <button className="ui icon button" onClick={ handleSubmit } disabled={ submitting }>
